...
TStyle *setTDRStyle() {
  ...
  tdrStyle->SetStatFontSize(0.04);///---> tdrStyle->SetStatFontSize(0.025);
  tdrStyle->SetStatTextColor(1);
  tdrStyle->SetStatFormat("6.4g");
  tdrStyle->SetStatBorderSize(1);
  tdrStyle->SetStatH(0.1);
  tdrStyle->SetStatW(0.2);///---> tdrStyle->SetStatW(0.15);
  */
  ...
  // tdrStyle->SetTitleBorderSize(2);                                     //*******************************88
